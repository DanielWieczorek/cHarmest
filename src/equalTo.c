...
bool integerequalTo(int input){
	...
	addMessageToList(buildMessage("equalTo()",desiredIntegerString, actualIntegerString, result));
	return result;
}
bool pointerequalTo(void* input){
	...
	char desiredPointerString[100];
		...
		addMessageToList(buildMessage("equalTo()",desiredPointerString, actualPointerString, result));
	return result;
}
...
bool stringequalTo(char* input){
	...
	addMessageToList(buildMessage("equalTo()",desiredString, actualString, result));
	return result;
}
